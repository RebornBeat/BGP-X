...
| BGP-X Client Node | IP20-IP65 (variant-dependent) | -20°C to +60°C |
| BGP-X Adapter | IP20 | 0°C to +50°C |

---

## 11. Compatible Third-Party Hardware
...
## 15. Note on Broadcast Amplifier (Deprecated Concept)
...
**For range extension use cases**, use the BGP-X Node v1 in Range Extension mode. The STM32H7 is not suitable for running the full BGP-X daemon (requires Linux for async I/O, full crypto stack, DHT).
